												...
												<div class="form-group">
													...
													<div class="form-field">
														...
														<select name="start" id="people" class="form-control">
															<option  value >--Selcect an option</option>
												...
												<div class="form-group">
													...
													<div class="form-field">
														...
														<select name="end" id="people" class="form-control">
															<option  value >--Selcect an option</option>
															<option {{ $end==100000? 'selected':'' }} value="2000000">2.000.000 VNĐ</option>
															<option {{ $end==200000? 'selected':'' }} value="4000000">4.000.000 VNĐ</option>
															<option {{ $end==300000? 'selected':'' }} value="6000000">6.000.000 VNĐ</option>
															<option {{ $end==500000? 'selected':'' }} value="8000000">8.000.000 VNĐ</option>
															<option {{ $end===1000000? 'selected':'' }} value="10000000">10.000.000 VNĐ</option>
														</select>
													</div>
												</div>
											</div>
